...
describe('Teste do componente de paginação', ()=>{
    ...
    it('Deve renderizar o componente sem erros', ()=> {
        ...
        ReactDOM.render(<Paginacao totalItems={10} itemsPagina={10} paginaAtual={1} mudarPagina={()=> false}/>, div)
        ReactDOM.unmountComponentAtNode(div)
    })

    it('deve exibir a paginacao contendo 3 paginas', ()=>{
        const { getByTestId } = render(
            <Paginacao totalItems={15} itemsPagina={5} paginaAtual={1} mudarPagina={()=> false}/>
        )
